...
var _usePopoverPositioner = require("./usePopoverPositioner");
 ...
 */const PopoverPositioner = exports.PopoverPositioner = /*#__PURE__*/React.forwardRef(function PopoverPositioner(props, forwardedRef) {
  const {
    render,
    className,
    anchor,
  ...
  const positioner = (0, _usePopoverPositioner.usePopoverPositioner)({
    anchor,
    floatingRootContext,
    positionMethod,
    mounted,
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_PopoverPositionerContext.PopoverPositionerContext.Provider, {
    value: positioner,
    children: renderElement()
  });
});
process.env.NODE_ENV !== "production" ? PopoverPositioner.propTypes /* remove-proptypes */ = {
  // ┌────────────────────────────── Warning ──────────────────────────────┐
