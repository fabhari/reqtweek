...
function useSliderRoot(parameters) {
  ...
  function initializePercentageValues() {
    ...
    for (let i = 0; i < values.length; i += 1) {
      vals.push((0, _valueToPercent.valueToPercent)(values[i], min, max));
    }
    return vals;
  }
  ...
  return React.useMemo(() => ({
    ...
    thumbRefs,
    values
  }), [getRootProps, active, ariaLabelledby, disabled, dragging, getFingerState, handleInputChange, largeStep, lastChangedValueRef, max, min, minStepsBetweenValues, name, onValueCommitted, orientation, percentageValues, range, registerSliderControl, setActive, setDragging, setPercentageValues, setThumbMap, setValue, step, thumbMap, thumbRefs, values]);
}