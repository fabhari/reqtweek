...
export declare namespace useSliderControl {
    interface Parameters extends Pick<useSliderRoot.ReturnValue, 'disabled' | 'dragging' | 'getFingerState' | 'lastChangedValueRef' | 'minStepsBetweenValues' | 'onValueCommitted' | 'percentageValues' | 'registerSliderControl' | 'setActive' | 'setDragging' | 'setValue' | 'step' | 'thumbRefs'> {
        /**
