...
function useSliderThumb(parameters) {
      ...
      onKeyDown(event) {
        ...
        switch (event.key) {
          ...
          case _composite.ARROW_RIGHT:
            newValue = getNewValue(thumbValue, event.shiftKey ? largeStep : step, isRtl ? -1 : 1, min, max);
            break;
  ...
  }, [commitValidation, disabled, externalTabIndex, getThumbStyle, handleInputChange, index, isRtl, largeStep, max, mergedThumbRef, min, minStepsBetweenValues, setTouched, sliderValues, step, thumbId, thumbValue]);
  const getThumbInputProps = React.useCallback((externalProps = {}) => {
    let cssWritingMode;
    if (orientation === 'vertical') {
      cssWritingMode = isRtl ? 'vertical-rl' : 'vertical-lr';
    }
    return (0, _mergeReactProps.mergeReactProps)(getInputValidationProps(externalProps), {
