...
var _useCollapsibleTrigger = require("../../collapsible/trigger/useCollapsibleTrigger");
...
const AccordionTrigger = exports.AccordionTrigger = /*#__PURE__*/React.forwardRef(function AccordionTrigger(props, forwardedRef) {
  const {
  ...
  const {
    getRootProps
  } = (0, _useCollapsibleTrigger.useCollapsibleTrigger)({
    panelId,
