...
function useSelectItem(params) {
  ...
  const getItemProps = React.useCallback(externalProps => {
    return getButtonProps((0, _mergeReactProps.mergeReactProps)(externalProps, {
  ...
  }, [commitSelection, disabled, getButtonProps, highlighted, indexRef, open, popupRef, selected, selectionRef, setActiveIndex, typingRef]);
