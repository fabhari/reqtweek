...
function useSelectTrigger(parameters) {
  ...
  const getTriggerProps = React.useCallback(externalProps => {
    return getButtonProps((0, _mergeReactProps.mergeReactProps)(fieldControlValidation.getValidationProps(externalProps), {
  ...
  }, [alignItemToTrigger, disabled, fieldControlValidation, getButtonProps, handleRef, labelId, open, positionerElement, readOnly, setOpen, setTouched, setTouchModality, value]);
