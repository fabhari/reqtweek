 ...
 */
const SelectGroupLabel = exports.SelectGroupLabel = /*#__PURE__*/React.forwardRef(function SelectGroupLabel(props, forwardedRef) {
  const {
    className,
    render,
    id: idProp,
  ...
  const getSelectItemGroupLabelProps = React.useCallback((externalProps = {}) => (0, _mergeReactProps.mergeReactProps)(externalProps, {
    id
  }), [id]);
  const {
    renderElement
...
process.env.NODE_ENV !== "production" ? SelectGroupLabel.propTypes /* remove-proptypes */ = {
  // ┌────────────────────────────── Warning ──────────────────────────────┐
