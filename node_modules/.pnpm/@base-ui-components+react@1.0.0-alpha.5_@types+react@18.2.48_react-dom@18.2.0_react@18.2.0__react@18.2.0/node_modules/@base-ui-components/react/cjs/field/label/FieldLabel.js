...
var _useFieldLabel = require("./useFieldLabel");
 ...
 */
const FieldLabel = exports.FieldLabel = /*#__PURE__*/React.forwardRef(function FieldLabel(props, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
  ...
  const {
    getLabelProps
  } = (0, _useFieldLabel.useFieldLabel)();
  const {
    renderElement
