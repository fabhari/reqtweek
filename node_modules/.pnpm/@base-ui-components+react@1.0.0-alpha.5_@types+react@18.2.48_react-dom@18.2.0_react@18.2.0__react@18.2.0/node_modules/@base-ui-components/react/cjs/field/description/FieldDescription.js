...
var _useFieldDescription = require("./useFieldDescription");
 ...
 */
const FieldDescription = exports.FieldDescription = /*#__PURE__*/React.forwardRef(function FieldDescription(props, forwardedRef) {
  const {
    render,
    id,
    className,
  ...
  const {
    getDescriptionProps
  } = (0, _useFieldDescription.useFieldDescription)({
    id
  });
  const {
    renderElement
