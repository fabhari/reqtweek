 ...
 */
const ScrollAreaThumb = exports.ScrollAreaThumb = /*#__PURE__*/React.forwardRef(function ScrollAreaThumb(props, forwardedRef) {
  const {
    render,
    className,
    ...otherProps
  ...
  const mergedRef = (0, _useForkRef.useForkRef)(forwardedRef, orientation === 'vertical' ? thumbYRef : thumbXRef);
