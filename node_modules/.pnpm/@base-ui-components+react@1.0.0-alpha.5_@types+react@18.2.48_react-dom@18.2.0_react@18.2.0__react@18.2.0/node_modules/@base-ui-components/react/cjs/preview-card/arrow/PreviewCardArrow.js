 ...
 */
const PreviewCardArrow = exports.PreviewCardArrow = /*#__PURE__*/React.forwardRef(function PreviewCardArrow(props, forwardedRef) {
  const {
    render,
    className,
    ...otherProps
  ...
  const getArrowProps = React.useCallback((externalProps = {}) => (0, _mergeReactProps.mergeReactProps)(externalProps, {
    style: arrowStyles,
    'aria-hidden': true
  }), [arrowStyles]);
  ...
  const mergedRef = (0, _useForkRef.useForkRef)(arrowRef, forwardedRef);
  const {
    renderElement
