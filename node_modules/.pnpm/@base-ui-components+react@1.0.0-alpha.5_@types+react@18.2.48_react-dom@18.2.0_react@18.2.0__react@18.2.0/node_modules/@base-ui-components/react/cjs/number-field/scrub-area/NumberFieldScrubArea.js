 ...
 */
const NumberFieldScrubArea = exports.NumberFieldScrubArea = /*#__PURE__*/React.forwardRef(function NumberFieldScrubArea(props, forwardedRef) {
  const {
    render,
    className,
  ...
  const mergedRef = (0, _useForkRef.useForkRef)(scrubAreaRef, forwardedRef);
  const {
    renderElement
...
process.env.NODE_ENV !== "production" ? NumberFieldScrubArea.propTypes /* remove-proptypes */ = {
   ...
   * @default 2
   */
  pixelSensitivity: _propTypes.default.number,
  /**
   ...
   */
  teleportDistance: _propTypes.default.number
} : void 0;