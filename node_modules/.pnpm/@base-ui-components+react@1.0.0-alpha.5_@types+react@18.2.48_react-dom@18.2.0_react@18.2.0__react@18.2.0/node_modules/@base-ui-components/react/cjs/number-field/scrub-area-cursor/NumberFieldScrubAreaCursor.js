 ...
 */
const NumberFieldScrubAreaCursor = exports.NumberFieldScrubAreaCursor = /*#__PURE__*/React.forwardRef(function NumberFieldScrubAreaCursor(props, forwardedRef) {
  const {
    render,
    className,
    ...otherProps
  ...
  const mergedRef = (0, _useForkRef.useForkRef)(forwardedRef, scrubAreaCursorRef, setElement);
  const {
    renderElement
  ...
  if (!isScrubbing || (0, _detectBrowser.isWebKit)()) {
    return null;
  }
  return /*#__PURE__*/ReactDOM.createPortal(renderElement(), (0, _owner.ownerDocument)(element).body);
});
