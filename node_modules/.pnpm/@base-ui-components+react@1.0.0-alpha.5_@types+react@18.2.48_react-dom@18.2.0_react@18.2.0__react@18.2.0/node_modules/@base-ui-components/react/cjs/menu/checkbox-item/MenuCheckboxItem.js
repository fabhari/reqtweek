...
var _useMenuCheckboxItem = require("./useMenuCheckboxItem");
...
const InnerMenuCheckboxItem = /*#__PURE__*/React.forwardRef(function InnerMenuItem(props, forwardedRef) {
  ...
  const {
    getRootProps,
    checked
  } = (0, _useMenuCheckboxItem.useMenuCheckboxItem)({
    closeOnClick,
    disabled,
    highlighted,
    id,
...
process.env.NODE_ENV !== "production" ? InnerMenuCheckboxItem.propTypes /* remove-proptypes */ = {
  // ┌────────────────────────────── Warning ──────────────────────────────┐
...
const MenuCheckboxItem = exports.MenuCheckboxItem = /*#__PURE__*/React.forwardRef(function MenuCheckboxItem(props, forwardedRef) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(MemoizedInnerMenuCheckboxItem, {
    ...other,
    id: id,
    ref: mergedRef,
...
process.env.NODE_ENV !== "production" ? MenuCheckboxItem.propTypes /* remove-proptypes */ = {
  // ┌────────────────────────────── Warning ──────────────────────────────┐
  // │ These PropTypes are generated from the TypeScript type definitions. │
  // │ To update them, edit the TypeScript types and run `pnpm proptypes`. │
  // └─────────────────────────────────────────────────────────────────────┘
