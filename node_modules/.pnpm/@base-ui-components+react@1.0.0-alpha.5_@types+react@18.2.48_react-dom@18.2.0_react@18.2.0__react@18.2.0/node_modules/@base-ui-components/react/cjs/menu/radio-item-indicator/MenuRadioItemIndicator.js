 ...
 */
const MenuRadioItemIndicator = exports.MenuRadioItemIndicator = /*#__PURE__*/React.forwardRef(function MenuRadioItemIndicator(props, forwardedRef) {
  const {
    render,
    className,
    keepMounted = false,
  ...
  const getItemProps = React.useCallback((externalProps = {}) => (0, _mergeReactProps.mergeReactProps)(externalProps, {
    'aria-hidden': true,
    hidden: !mounted
  }), [mounted]);
...
process.env.NODE_ENV !== "production" ? MenuRadioItemIndicator.propTypes /* remove-proptypes */ = {
  // ┌────────────────────────────── Warning ──────────────────────────────┐
