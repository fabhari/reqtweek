...
const customStyleHookMapping = {
  ...
  hasNestedDialogs(value) {
    return value ? {
      [_AlertDialogPopupDataAttributes.AlertDialogPopupDataAttributes.hasNestedDialogs]: ''
    } : null;
  }
};
 ...
 */
const AlertDialogPopup = exports.AlertDialogPopup = /*#__PURE__*/React.forwardRef(function AlertDialogPopup(props, forwardedRef) {
  const {
    className,
    id,
    render,
