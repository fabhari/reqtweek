 ...
 */
export type BaseUIComponentProps<ElementType extends React.ElementType, State, RenderFunctionProps = GenericHTMLProps> = Omit<WithBaseUIEvent<React.ComponentPropsWithoutRef<ElementType>>, 'className'> & {
    /**
 ...
 */
export type Simplify<T> = T extends Function ? T : {
    [K in keyof T]: T[K];
};
