...
import { isFirefox, isIOS, isWebKit } from './detectBrowser.js';
 ...
 */
export function useScrollLock(enabled = true, referenceElement) {
  const isReactAriaHook = React.useMemo(() => enabled && (isIOS() || !supportsDvh() ||
  // macOS Firefox "pops" scroll containers' scrollbars with our standard scroll lock
  isFirefox() && !hasInsetScrollbars()), [enabled]);
  usePreventScroll({
