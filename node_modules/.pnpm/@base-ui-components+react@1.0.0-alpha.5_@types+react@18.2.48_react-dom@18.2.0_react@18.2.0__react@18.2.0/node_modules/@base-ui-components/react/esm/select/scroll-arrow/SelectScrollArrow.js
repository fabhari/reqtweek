 ...
 */
const SelectScrollArrow = /*#__PURE__*/React.forwardRef(function SelectScrollArrow(props, forwardedRef) {
  const {
    render,
    className,
    direction,
  ...
  const getScrollArrowProps = React.useCallback((externalProps = {}) => mergeReactProps(externalProps, {
    'aria-hidden': true,
