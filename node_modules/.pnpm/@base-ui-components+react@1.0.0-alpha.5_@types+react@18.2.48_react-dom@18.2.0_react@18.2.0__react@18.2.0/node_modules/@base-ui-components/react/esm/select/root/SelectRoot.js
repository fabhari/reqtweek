...
import { SelectRootContext } from './SelectRootContext.js';
import { SelectIndexContext } from './SelectIndexContext.js';
...
const SelectRoot = function SelectRoot(props) {
  const {
    value: valueProp,
    defaultValue = null,
    onValueChange,
  ...
  return /*#__PURE__*/_jsx(SelectRootContext.Provider, {
    ...
    children: /*#__PURE__*/_jsxs(SelectIndexContext.Provider, {
