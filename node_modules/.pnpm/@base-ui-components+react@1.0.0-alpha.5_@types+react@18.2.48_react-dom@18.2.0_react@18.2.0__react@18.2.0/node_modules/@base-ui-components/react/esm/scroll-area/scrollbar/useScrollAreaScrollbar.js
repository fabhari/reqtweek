...
export function useScrollAreaScrollbar(params) {
  const {
    orientation
  } = params;
  const {
  ...
  const getScrollbarProps = React.useCallback((externalProps = {}) => mergeReactProps(externalProps, {
    ...(rootId && {
  ...
  }), [rootId, handlePointerUp, orientation, direction, thumbSize.height, thumbSize.width, viewportRef, thumbYRef, scrollbarYRef, thumbXRef, scrollbarXRef, handlePointerDown]);
